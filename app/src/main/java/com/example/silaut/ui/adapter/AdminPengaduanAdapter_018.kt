...
class AdminPengaduanAdapter_018(
    private val list_018: List<Pengaduan_018>,
    private val onStatusClick_018: (Pengaduan_018) -> Unit
) : RecyclerView.Adapter<AdminPengaduanAdapter_018.ViewHolder>() {
